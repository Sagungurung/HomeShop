<header class="main-header">
    ...
    <a href="{{route('seller.dashboard')}}" class="logo">
      ...
      <span class="logo-lg"><b>Welcome {{$sellers->firstname}}</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/uploads/sellerPhotos/{{$sellers->image}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Member since {{$sellers->created_at}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">
